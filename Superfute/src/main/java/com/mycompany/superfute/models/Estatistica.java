...
public class Estatistica {
    ...
    public String toString() {
        return "Estatistica{" + "anoLiga=" + anoLiga + ", numJornada=" 
                + numJornada + ", Gol=" + Gol + ", golSofrido=" + golSofrido
                + ", amarelo=" + amarelo + ", amareloDuplo=" + amareloDuplo +
                ", vermelho=" + vermelho + ", ponto=" + ponto + ", casaFora=" 
                + casaFora + ", resultado=" + resultado + ", quantJogos=" + quantJogos + '}';
    }
